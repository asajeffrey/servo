...
impl WebGLTexture {
    fn new_inherited(context: &WebGLRenderingContext, id: WebGLTextureId, owner: WebGLTextureOwner) -> Self {
        Self {
    ...
    pub fn new(context: &WebGLRenderingContext, id: WebGLTextureId) -> DomRoot<Self> {
        reflect_dom_object(
            Box::new(WebGLTexture::new_inherited(context, id, WebGLTextureOwner::WebGL)),
            &*context.global(),
        )
    }
    ...
    pub fn new_webxr(context: &WebGLRenderingContext, id: WebGLTextureId) -> DomRoot<Self> {
        reflect_dom_object(
            Box::new(WebGLTexture::new_inherited(context, id, WebGLTextureOwner::WebXR)),
            &*context.global(),
        )
    }
}
